...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", as, ...props }, ref) => {
    const variants = {
      primary: "bg-[#89713B] text-white hover:bg-[#6F5B2F] shadow-lg shadow-[#89713B]/20",
      secondary: "bg-slate-900 text-white hover:bg-slate-800",
      outline: "border-2 border-[#89713B] text-[#89713B] hover:bg-[#89713B]/10",
      white: "bg-white text-[#2B2413] hover:bg-[#89713B]/10 shadow-md",
    };
    const sizes = {
