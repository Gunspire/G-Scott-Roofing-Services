          ...
          <nav className="hidden md:flex items-center gap-8">
            {mainNavItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="text-slate-600 hover:text-[#89713B] font-medium transition-colors"
              >
                {item.label}
              </a>
            ))}
            ...
            >
              <button
                ...
                className="inline-flex items-center gap-2 text-slate-600 hover:text-[#89713B] font-medium transition-colors"
              >
                Features
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex flex-col items-end">
              ...
              <a
                ...
                className="flex items-center gap-2 text-lg font-bold text-slate-900 hover:text-[#89713B] transition-colors"
              >
                <Phone className="w-5 h-5 text-[#89713B]" />
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-slate-100 p-4 absolute w-full shadow-lg">
          <div className="flex flex-col space-y-4">
            ...
            <a
              href={telHref(COMPANY.phoneRaw)}
              className="flex items-center gap-2 text-[#89713B] font-bold py-2"
            >
