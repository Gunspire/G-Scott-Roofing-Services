...
import { COMPANY, mailtoHref, telHref, waMeHref } from "../lib/company";
  ...
  return (
    <section className="relative overflow-hidden py-16 lg:py-20">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[#1A160B]/80" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-5 text-white">
            <p className="text-[#E7DDC9] font-semibold tracking-wider text-sm uppercase mb-3">
              Get in touch
            </p>
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight">
              Get a Free Quote — Fast Response, No Obligation
            </h2>
            <p className="text-[#F4F0E6]/90 mt-4 text-lg leading-relaxed">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#F4F0E6]/90 text-sm mt-1">{COMPANY.phoneDisplay}</p>
                    <p className="text-[#E7DDC9] text-xs mt-1">Emergency call-outs</p>
                  </div>
                </div>
              </a>

              <a
                href={waMeHref(COMPANY.whatsapp.phoneWaMe, COMPANY.whatsapp.defaultMessage)}
                target="_blank"
                rel="noreferrer"
                className="group rounded-2xl bg-white/10 border border-white/15 backdrop-blur px-5 py-4 hover:bg-white/15 transition"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#F4F0E6]/90 text-sm mt-1">Send photos & get a quick estimate</p>
                    <p className="text-[#E7DDC9] text-xs mt-1">Typical reply within 1–2 hours</p>
                  </div>
                </div>
              </a>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#F4F0E6]/90 text-sm mt-1">{COMPANY.email}</p>
                    <p className="text-[#E7DDC9] text-xs mt-1">
            ...
            <div className="mt-8 flex items-center gap-3 text-[#F4F0E6]/90">
              <ShieldCheck className="w-5 h-5 text-[#E7DDC9]" />
                ...
                {footerFormStatus === "success" ? (
                  ...
                  <>
                    <div className="flex items-start justify-between gap-4 mb-6">
                      ...
                      <div className="hidden sm:flex items-center gap-2 rounded-full bg-[#89713B]/10 border border-[#89713B]/20 px-3 py-1.5 text-xs font-semibold text-[#2B2413]">
                    ...
                    <form onSubmit={handleFooterQuoteSubmit} className="space-y-4">
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <input
                            type="text"
                            required
                            className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition-all bg-white"
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <select className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition-all bg-white">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <textarea
                          rows={4}
                          className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition-all bg-white resize-none"
