              ...
              <div className="mt-4 space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition-all bg-white"
                  />
                </div>
          ...
          <div className="lg:col-span-7">
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 sm:p-8 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-2xl bg-[#89713B]/10 border border-[#89713B]/20 flex items-center justify-center">
                  <MessageSquareText className="w-6 h-6 text-[#89713B]" />
                </div>
                <div>
              ...
              <div className="mt-6">
                <UpsidesBox className="bg-slate-50">
                  <div className="rounded-2xl border border-slate-200 bg-white p-5">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-2xl bg-[#89713B]/10 border border-[#89713B]/20 flex items-center justify-center">
                        <TrendingUp className="w-5 h-5 text-[#89713B]" />
                      </div>
                      <div>
