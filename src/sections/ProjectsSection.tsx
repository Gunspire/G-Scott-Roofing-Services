          ...
          {[
            {
              ...
              alt: "Completed slate roof replacement on a heritage home near Sevenoaks",
            },
            {
              img: "/hero-1.png",
              ...
              alt: "Completed new tiled roof installation on a residential home near Dartford",
            },
            {
              img: "/hero-bg.png",
              ...
              alt: "Storm damage roof repair completed on a property in Swanley",
            },
          ].map((project, i) => (
            <div
              key={i}
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/95 via-slate-900/25 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                ...
                <p className="text-[#E7DDC9] font-semibold flex items-center gap-1 mt-1">
                  <MapPin className="w-4 h-4" /> {project.loc}
                </p>

                <div className="mt-4 grid grid-cols-2 gap-3 text-sm text-slate-200">
                  <div className="flex items-center gap-2">
                    <CalendarDays className="w-4 h-4 text-[#E7DDC9]" />
                    <span className="font-medium">{project.date}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock className="w-4 h-4 text-[#E7DDC9]" />
