          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-[#89713B]/10 border border-[#89713B]/20 flex items-center justify-center">
                <Bell className="w-6 h-6 text-[#89713B]" />
              </div>
              <div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-2 rounded-full bg-[#89713B]/10 border border-[#89713B]/20 px-3 py-1 text-xs font-extrabold text-[#2B2413]">
                    <Bell className="w-4 h-4" />
                    New notification
                  </span>
                  <span className="text-xs font-semibold text-slate-500">
                    {COMPANY.name} • {lead.receivedAt}
                  </span>
                </div>
