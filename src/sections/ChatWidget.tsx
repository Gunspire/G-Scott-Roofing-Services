...
import { COMPANY, mailtoHref, telHref } from "../lib/company";
      ...
      <div className="relative">
        {chatOpen && (
          <div className="w-[340px] max-w-[calc(100vw-2.5rem)] rounded-3xl overflow-hidden border border-slate-200 shadow-2xl bg-white">
            <div className="bg-gradient-to-r from-[#2B2413] via-[#89713B] to-[#2B2413] px-5 py-4 text-white">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-sm font-semibold text-[#F4F0E6]">{COMPANY.name}</p>
                  <p className="text-lg font-bold leading-tight">How can we help?</p>
                  <p className="text-xs text-[#F4F0E6]/90 mt-1">
                    Typical reply within 1 hour (Mon–Fri)
                  </p>
                </div>
                <button
                  type="button"
                  ...
                  <form onSubmit={handleChatSubmit} className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        ...
                        <input
                          required
                          type="text"
                          className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition text-sm"
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        required
                        rows={3}
                        className="w-full px-3 py-2 rounded-lg border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition text-sm resize-none"
        ...
        {!chatOpen && (
          <button
            ...
            className="rounded-full shadow-2xl bg-[#89713B] hover:bg-[#6F5B2F] transition text-white px-4 py-3 flex items-center gap-2"
