          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
              <div className="bg-white rounded-xl border border-slate-200 px-4 py-3 shadow-sm flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-[#89713B]/10 flex items-center justify-center">
                  <MapPin className="w-5 h-5 text-[#89713B]" />
                </div>
                <div>
                  <p className="text-xs text-slate-500 font-medium">Location</p>
                  <p className="text-sm font-bold text-slate-900">{COMPANY.serviceAreaShort}</p>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-slate-200 px-4 py-3 shadow-sm flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-[#89713B]/10 flex items-center justify-center">
                  <Clock className="w-5 h-5 text-[#89713B]" />
                </div>
                <div>
          ...
          <div className="relative">
            ...
            <div className="mt-6 bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
              ...
              <p className="text-slate-700 leading-relaxed italic">
                “We rang after noticing water marks in the loft. The team came out the same day,
                made it safe, and had the roof fully repaired within 48 hours. Clean, polite, and
                the finish is spot on.”
              </p>
              <div className="flex items-center gap-3 mt-5">
                <div className="w-10 h-10 bg-[#89713B]/15 rounded-full flex items-center justify-center text-[#2B2413] font-bold">
                  H
                </div>
                <div>
                  <p className="text-slate-900 font-bold text-sm">Helen P.</p>
                  <p className="text-slate-500 text-xs">{COMPANY.serviceAreaShort} • Emergency storm repair</p>
                </div>
              </div>
            </div>
          </div>
