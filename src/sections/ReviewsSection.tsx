    ...
    <section id="reviews" className="py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 px-6 py-5 shadow-sm">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-1">
                    ...
                    {" "}from homeowners around {COMPANY.serviceAreaLong}.
                  </p>
                </div>
              </div>
              ...
              <div className="inline-flex items-center gap-2 rounded-full bg-white border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-800 shadow-sm">
                <BadgeCheck className="w-4 h-4 text-[#89713B]" />
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              text: "Fantastic from start to finish. Gave a clear quote, turned up on time, and the new roof looks amazing. Left the garden spotless too.",
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 bg-[#89713B]/15 rounded-full flex items-center justify-center text-[#2B2413] font-bold">
                    {review.author[0]}
                  </div>
                  <div>
