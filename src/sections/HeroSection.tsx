      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-8">
            <div className="inline-flex items-center gap-2 bg-[#89713B]/20 border border-[#89713B]/30 rounded-full px-4 py-1.5 mb-6 backdrop-blur-sm">
              <BadgeCheck className="w-4 h-4 text-[#E7DDC9]" />
              <span className="text-[#F4F0E6] text-sm font-medium">Trusted local roofing specialists</span>
            </div>

            <h1 className="text-3xl lg:text-5xl font-bold text-white leading-tight mb-6">
              Roofing services in <span className="text-[#E7DDC9]">{COMPANY.serviceAreaShort}</span>. Fast
              quotes, tidy work, guaranteed results.
            </h1>

            <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl">
              From emergency repairs to full roof replacements, we provide reliable, high-quality
              workmanship in {COMPANY.serviceAreaLong}.
            </p>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-slate-700/50">
              <div className="flex flex-col max-w-[200px]">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 bg-[#89713B] rounded-full flex items-center justify-center text-xs font-bold text-white">
                    J
                  </div>
              ...
              <>
                ...
                <form onSubmit={handleQuoteSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        type="text"
                        required
                        className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition-all"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      rows={3}
                      className="w-full px-4 py-2.5 rounded-lg border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition-all resize-none"
