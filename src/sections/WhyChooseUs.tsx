      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-7">
            <SectionHeading subtitle={`Why ${COMPANY.name}`} className="mb-8">
            ...
            <div className="mt-7 grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-2xl">
              {[
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-[#89713B]/10 border border-[#89713B]/20 flex items-center justify-center shrink-0">
                    <s.icon className="w-5 h-5 text-[#89713B]" />
                  </div>
            ...
            <div className="mt-8 grid sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#89713B]/15 flex items-center justify-center">
                    <ShieldCheck className="w-5 h-5 text-[#89713B]" />
                  </div>
                  <div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#89713B]/15 flex items-center justify-center">
                    <BadgeCheck className="w-5 h-5 text-[#89713B]" />
                  </div>
                  <div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#89713B]/15 flex items-center justify-center">
                    <CheckCircle2 className="w-5 h-5 text-[#89713B]" />
                  </div>
                  <div>
          ...
          <div className="lg:col-span-5">
            <div className="rounded-3xl border border-slate-200 bg-slate-50 shadow-lg overflow-hidden">
              <div className="aspect-[4/5] relative">
                <img
                  src="/Untitled%20(2).jpg"
                  alt={`${COMPANY.name} office and fleet`}
