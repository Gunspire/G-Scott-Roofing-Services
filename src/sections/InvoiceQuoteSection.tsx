              ...
              <div className="mt-4 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition-all bg-white text-base"
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white px-5 py-4">
                    ...
                    <input
                      ...
                      value={areaSqm}
                      onChange={(e) => setAreaSqm(Number(e.target.value))}
                      className="mt-2 w-full accent-[#89713B]"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 rounded-3xl border border-slate-200 bg-white p-5 sm:p-6">
                  ...
                  {(Object.keys(PRICING.addons) as Array<keyof typeof PRICING.addons>).map((k) => (
                    <button
                      ...
                      className={cn(
                        ...
                        addons[k]
                          ? "border-[#89713B]/25 bg-[#89713B]/10 text-[#2B2413]"
              ...
              <div className="mt-5 space-y-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-[#89713B] focus:ring-2 focus:ring-[#89713B]/25 outline-none transition-all bg-white resize-none text-base"
