              ...
              <ul className="mt-4 space-y-3 text-sm text-slate-700">
                <li className="flex gap-3">
                  <span className="mt-0.5">
                    <Search className="w-5 h-5 text-[#89713B]" />
                  </span>
                  <span>
                ...
                <li className="flex gap-3">
                  <span className="mt-0.5">
                    <FileText className="w-5 h-5 text-[#89713B]" />
                  </span>
                  <span>
                ...
                <li className="flex gap-3">
                  <span className="mt-0.5">
                    <Sparkles className="w-5 h-5 text-[#89713B]" />
                  </span>
                  <span>
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 sm:p-8 shadow-sm">
              ...
              <div className="mt-6 grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  {
                    t: "Local intent",
                    d: "Swanley, Dartford, Sevenoaks, Orpington — and the specific towns you want to win.",
                  },
                  {
                    t: "Proof intent",
